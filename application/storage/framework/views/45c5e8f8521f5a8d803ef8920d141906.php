<div class="setup-welcome">
    ...
    <div class="alert alert-warning p-b-15">
        ...
        <div class="cronjob m-b-20">
            <input class="col-12 form-control form-control-sm" type="text" value="<?php echo e($cron_path_1 ?? '---'); ?>" disabled>
        </div>
        <div class="cronjob m-t-10 m-b-10">
            <input class="col-12 form-control form-control-sm" type="text" value="<?php echo e($cron_path_2 ?? '---'); ?>" disabled>
        </div>
    </div>
    ...
    <div class="alert alert-warning m-t-40 p-b-15">   
        ...
        <div class="m-b-20 m-t-10">Use your web hosting control panel to create <strong>wildcard domain</strong> below.
            <a href="https://growcrm.io/documentation/saas-installation" target="_blank">[help]</a></div>
        <div class="cronjob m-t-10 m-b-10">
            <input class="col-12 form-control form-control-sm" type="text" value="<?php echo e($wildcard_domain ?? '---'); ?>" disabled>
        </div>
    </div>


    <div class="x-button m-t-20">
        <a href="<?php echo e(url('/app-admin')); ?>" class="btn waves-effect waves-light btn-block btn-info">Go To My Dashboard</a>
    </div>


</div><?php /**PATH /Users/gilberto/Development/crm/grow/application/resources/views/pages/install/finish.blade.php ENDPATH**/ ?>